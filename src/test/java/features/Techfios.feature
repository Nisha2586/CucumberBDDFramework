...
Feature: Techfios billing Login Functionality Validation
  ...
  Scenario Outline: User should be able to login with valid credentials and open new account
    ...
    Examples: 
      ...
      | demo@techfios.com | abc123   | Savings account | Nisha FD1    |            1000 |       12345667 | kelly          | 123 123 1234 | https://www.usbank.com/online-mobile-banking/online-account-login.html       |
